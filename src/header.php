...
<div class="header">
	<div class="logo">
		<a href="index.php">Asistencia RFID</a>
	</div>
</div>
<?php  
  if (isset($_GET['error'])) {
	...
	if (isset($_GET['login'])) {
	    if ($_GET['login'] == "success") {
	      echo '<script type="text/javascript">
	              ...
	              setTimeout(function () {
	                $(".up_info2").fadeIn(200);
	                $(".up_info2").text("Iniciaste sesión exitosamente");
	              }, 500);
...
<div class="topnav" id="myTopnav">
    ...
    <a href="ManageUsers.php">Administrar Usuarios</a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLongTitle">Actualice su información de la cuenta:</h3>
      ...
      <form action="ac_update.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-body">
	      	<label for="User-mail"><b>Nombre del administrador:</b></label>
	      	<input type="text" name="up_name" placeholder="Ingrese su nombre..." value="<?php echo $_SESSION['Admin-name']; ?>" required/><br>
	      	<label for="User-mail"><b>E-mail del administrador:</b></label>
	      	<input type="email" name="up_email" placeholder="Ingrese su E-mail..." value="<?php echo $_SESSION['Admin-email']; ?>" required/><br>
	      	<label for="User-psw"><b>Contraseña</b></label>
	      	<input type="password" name="up_pwd" placeholder="Ingrese su contraseña..." required/><br>
	      </div>
