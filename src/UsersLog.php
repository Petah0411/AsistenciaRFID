...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Registros Diarios de los Usuarios</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Filtrar Registro/ Exportar a Excel</button>
    </div>
    <!-- Log filter -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filtrar Registro de Usuario:</h3>
            ...
            <div class="modal-body">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      ...
                      <label for="Start-Date"><b>Seleccionar desde esta fecha:</b></label>
                      <input type="date" name="date_sel_start" id="date_sel_start">
                      <label for="End -Date"><b>Al final de esta fecha:</b></label>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <div class="time">
                          ...
                          <label for="radio-one">Entrada</label>
                          <input type="radio" id="radio-two" name="time_sel" class="time_sel" value="Time_out" />
                          <label for="radio-two">Salida</label>
                        </div>
                      </div>
                      <div class="panel-body">
                        <label for="Start-Time"><b>Seleccionar desde esta hora:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Al final de esta hora:</b></label>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filtrar por Carrera/Dispositivo:</b></label>
                    <select class="dev_sel" name="dev_sel" id="dev_sel">
                      <option value="0">Todas las Carreras/Dispositivos</option>
                      <?php
                        require'connectDB.php';
                  ...
                  <div class="col-lg-4 col-sm-12">
                    ...
                    <input type="submit" name="To_Excel" value="Exportar">
                  </div>
                </div>
              </div>
            </div>
